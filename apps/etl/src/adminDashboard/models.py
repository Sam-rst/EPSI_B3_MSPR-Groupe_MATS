...
class UserManager:
    ...
    def add_user(self, username: str, password: str, role: str, region: str) -> bool:
        ...
        if not success:
            messagebox.showwarning(
                "Attention", f"Impossible d'ajouter l'utilisateur {username}."
            )
    ...
    def delete_user(self, user_id: int) -> bool:
        ...
        if not success:
            messagebox.showwarning(
                "Attention", f"Impossible de supprimer l'utilisateur avec ID {user_id}."
            )
    ...
    def _get_role_id(self, role_name: str) -> int:
        ...
        """
        role_mapping = {"admin": 1, "user": 2, "manager": 3, "analyst": 4, "guest": 5}
